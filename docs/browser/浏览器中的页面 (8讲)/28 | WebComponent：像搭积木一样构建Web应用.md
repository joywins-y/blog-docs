...
![Alt text](../../public/browser/page-in-browser/28/cover-picture-28.webp)

<audio preload="none" controls loop style="width: 100%;">
  <source src="../mp3/28-WebComponent：像搭积木一样构建Web应用.mp3" type="audio/mpeg">
  <p>你的浏览器不支持HTML5音频，你可以<a href="../mp3/28-WebComponent：像搭积木一样构建Web应用.mp3">下载</a>这个音频文件</p>
</audio>
...
![使用影子 DOM 的输出效果](../../public/browser/page-in-browser/28/image.png)

<div style="text-align: center; font-size: 12px; color: #999; margin-bottom: 8px;">使用影子 DOM 的输出效果</div>
...
![影子 DOM 示意图](../../public/browser/page-in-browser/28/image-1.png)

<div style="text-align: center; font-size: 12px; color: #999; margin-bottom: 8px;">影子 DOM 示意图</div>
