...
![Alt text](../../public/browser/view-browser/01/task-manager.png)
...
![进程线程处理](../../public/browser/view-browser/01/process-threading.png "进程线程处理 ")
...
对于**内存泄漏的解决方法**那就更简单了，因为当关闭一个页面时，整个渲染进程也会被关闭，之后该进程所占用的内存都会被系统回收，这样就轻松解决了浏览器页面的内存泄漏问题。
...
![Alt text](../../public/browser/view-browser/01/service-consolidation.png "服务合并到浏览器进程")
...
其他文章：
[浏览器发展史和它的多进程架构](https://juejin.cn/post/7005516199635189796)
