import{_ as i,o as t,c as a,O as o,z as n,a as e}from"./chunks/framework.9b05e480.js";const S=JSON.parse('{"title":"纯 CSS 实现的三种通知栏滚动效果","description":"","frontmatter":{},"headers":[],"relativePath":"css/scrolling-effect.md","filePath":"css/scrolling-effect.md","lastUpdated":1686208751000}'),s={name:"css/scrolling-effect.md"},l=o('<h1 id="纯-css-实现的三种通知栏滚动效果" tabindex="-1">纯 CSS 实现的三种通知栏滚动效果 <a class="header-anchor" href="#纯-css-实现的三种通知栏滚动效果" aria-label="Permalink to &quot;纯 CSS 实现的三种通知栏滚动效果&quot;">​</a></h1><p><a href="http://www.10qianwan.com/articledetail/764762.html" target="_blank" rel="noreferrer">纯 CSS 实现的三种通知栏滚动效果</a></p><h2 id="第一种" tabindex="-1">第一种 <a class="header-anchor" href="#第一种" aria-label="Permalink to &quot;第一种&quot;">​</a></h2><blockquote><ol><li>视口容器高度需要固定，超出视口容器隐藏内容；</li><li>为了营造出无缝滚动回来，内容需要准备两份，彼此紧随；</li><li>通过移动内层 translatey 实现滚动效果；</li><li>在第一份内容完全滚出视口容器的一瞬间，立刻将内容位置进行复原；</li><li>通过 infinite 来循环此过程；</li></ol></blockquote>',4),r=n("iframe",{height:"400",width:"90%",frameborder:"0",allowfullscreen:"",srcdoc:`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<html lang="en">
 ...
 `,-1),v=[l,r,c,d,p,_,m,h];function x(g,f,u,y,b,w){return t(),a("div",null,v)}const T=i(s,[["render",x]]);export{S as __pageData,T as default};
